...
- **Architecture research:** `docs/research/` contains a subsystem-by-subsystem map of the reference (see `docs/research/00-overview.md`). Read it before engineering decisions.
